        ...
        execute: function() {
            SheetFactory = (function () {
                ...
                SheetFactory.prototype.getAssetGroups = function (inSheet) {
                    ...
                    assets1[0] = new asset_1.Asset('Diamond Inc.', 'SAD', '10%', '6%', '42%');
                    assets1[1] = new asset_1.Asset('Indian African Co.', 'IAC', '5%', '2%', '12%');
                    assets1[2] = new asset_1.Asset('Plutonion International', 'PLI', '15%', '1%', '15%');
                    assetGroup = new assetGroup_1.AssetGroup('South Africa', '30%', '11%', '4%', assets1);
                    ret[0] = assetGroup;
                    var assets2 = new Array();
                    assets2[0] = new asset_1.Asset('Tea and Coffee Inc.', 'TCI', '20%', '12%', '32%');
                    assets2[1] = new asset_1.Asset('Caribe Banana Co.', 'CBC', '25%', '12%', '22%');
                    assets2[2] = new asset_1.Asset('Rasta Co', 'RCO', '5%', '2%', '20%');
                    assetGroup = new assetGroup_1.AssetGroup('Jamaica', '50%', '21%', '2%', assets2);
                    ret[1] = assetGroup;
                    var assets3 = new Array();
                    assets3[0] = new asset_1.Asset('Mekong Lmtd', 'MKL', '12%', '6%', '2%');
                    assets3[1] = new asset_1.Asset('Monks', 'MNK', '8%', '7%', '17%');
                    assetGroup = new assetGroup_1.AssetGroup('Cambodia', '20%', '14%', '3%', assets3);
                    ret[2] = assetGroup;
                    return ret;
                };
                return SheetFactory;
