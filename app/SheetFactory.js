        ...
        execute: function() {
            SheetFactory = (function () {
                ...
                SheetFactory.prototype.getAssetGroups = function (inSheet) {
                    ...
                    assets1[2] = new asset_1.Asset('Plutonion International', 'PLI', 15, '1%', '15%', 0, 10);
                    ...
                    assets2[2] = new asset_1.Asset('Rasta Co', 'RCO', 5, '2%', '20%', 10, 30);
                    assetGroup = new assetGroup_1.AssetGroup('Jamaica', 50, '21%', '2%', assets2, 20, 60);
                    ret[1] = assetGroup;
                    var assets3 = new Array();
                    assets3[0] = new asset_1.Asset('Mekong Lmtd', 'MKL', 12, '6%', '2%', 0, 20);
                    assets3[1] = new asset_1.Asset('Monks', 'MNK', 8, '7%', '17%', 0, 10);
