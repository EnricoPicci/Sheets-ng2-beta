System.register(['../app/sheet', '../app/sheetBackEnd.service', '../app/asset', '../app/assetGroup'], function(exports_1) {
    var __extends = (this && this.__extends) || function (d, b) {
        for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
        function __() { this.constructor = d; }
        d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
    };
    var sheet_1, sheetBackEnd_service_1, asset_1, assetGroup_1;
    var SheetFactory;
    return {
        setters:[
            function (sheet_1_1) {
        ...
        execute: function() {
            SheetFactory = (function (_super) {
                __extends(SheetFactory, _super);
